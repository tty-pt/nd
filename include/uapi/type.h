...
#define SIC_DEF(ftype, fname, ...) \
    void fname##_adapter_call(void *fname) { \
...
SIC_DECL(int, sic_add, unsigned, ref, unsigned, skel_id, unsigned, where_id)
...
SIC_DECL(int, sic_spawn, unsigned, player_ref, unsigned, loc_ref, struct bio, bio, morton_t, pos)
